...
public class CameraSession
{
    ...
    private static final String TAG = CameraSession.class.getSimpleName();
    ...
    public CameraSession(CameraInfo info, Size preview, Size picture, int format)
    {
        ...
        SharedPreferences sharedPreferences = App.applicationContext.getSharedPreferences("camera", Activity.MODE_PRIVATE);
        ...
        orientationEventListener = new OrientationEventListener(App.applicationContext)
        {
            @Override
            public void onOrientationChanged(int orientation)
            {
                ...
                WindowManager mgr = (WindowManager) App.applicationContext.getSystemService(Context.WINDOW_SERVICE);
            ...
            if (camera != null) {
                ...
                if (params != null) {
                    if (BuildVars.LOGS_ENABLED) {
                        LOG.d("set preview size = " + previewSize.getWidth() + " " + previewSize.getHeight());
                    }
                    params.setPreviewSize(previewSize.getWidth(), previewSize.getHeight());
                    if (BuildVars.LOGS_ENABLED) {
                        LOG.d("set picture size = " + pictureSize.getWidth() + " " + pictureSize.getHeight());
                    }
