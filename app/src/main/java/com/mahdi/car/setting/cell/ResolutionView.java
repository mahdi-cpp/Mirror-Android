...
public class ResolutionView extends CellView {
    ...
    private static final int ITEM_ONE = itemCount++;
    private static final int ITEM_TOW = itemCount++;
    private static final int ITEM_THREE = itemCount++;
    private static final int ITEM_FOR = itemCount++;
    ...
    public ResolutionView(Context context) {
        ...
        titleLayout = new StaticLayout("Resolution", Themp.TEXT_PAINT_FILL_BLACK[6], width, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);

        quality720Layout = new StaticLayout("Fluent", Themp.TEXT_PAINT_FILL_BLACK[6], width, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        quality1080Layout = new StaticLayout("Hd", Themp.TEXT_PAINT_FILL_BLACK[6], width, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        quality1280Layout = new StaticLayout("Full HD", Themp.TEXT_PAINT_FILL_BLACK[6], width, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        quality1920Layout = new StaticLayout("Ultra HD", Themp.TEXT_PAINT_FILL_BLACK[6], width, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
